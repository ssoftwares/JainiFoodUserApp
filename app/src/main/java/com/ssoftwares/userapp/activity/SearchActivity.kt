...
import com.ssoftwares.userapp.model.FoodItemModel
import com.ssoftwares.userapp.model.FoodItemResponseModel
        ...
        if (isFirstTime) {
            foodAdapter = object : BaseAdaptor<FoodItemModel>(this@SearchActivity, foodList!!) {
                ...
                override fun onBindData(
                    ...
                    //tvFoodPriceList.text = Common.getCurrancy(this@SearchActivity).plus(String.format(Locale.US,"%.2f",foodList!!.get(position).getItem_price()!!.toDouble()))
