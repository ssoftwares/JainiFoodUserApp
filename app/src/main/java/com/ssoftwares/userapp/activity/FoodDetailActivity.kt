...
import com.ssoftwares.userapp.adaptor.ImageSliderAdaptor
...
import com.ssoftwares.userapp.model.CartCountModel
import com.ssoftwares.userapp.model.IngredientsModel
import com.ssoftwares.userapp.model.ItemDetailModel
...
class FoodDetailActivity : BaseActivity() {
    ...
    private fun callApiAddToCart(
        ...
        map.put("price",String.format(Locale.US,"%.02f",price.toDouble()))
    ...
    private fun setRestaurantData(restResponce: ItemDetailModel?) {
        ...
        if (restResponce.getAddons().size > 0) {
            ...
            ivAddAdons.imageTintList = ColorStateList.valueOf(resources.getColor(R.color.gray))
        }
            ...
            object : BaseAdaptor<AddonsModel>(this@FoodDetailActivity, getAddonsList) {
                ...
                override fun onBindData(
                    ...
                    if (getAddonsList[position].isSelectAddons()!!) {
                        ivCheck.setImageDrawable(resources.getDrawable(R.drawable.ic_check))
                        ivCheck.imageTintList =
                            ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                    } else {
                        ivCheck.setImageDrawable(resources.getDrawable(R.drawable.ic_uncheck))
                        ivCheck.imageTintList =
                            ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                    }
