...
import com.ssoftwares.userapp.activity.OrderDetailActivity
...
import com.ssoftwares.userapp.model.OrderHistoryModel
...
import com.ssoftwares.userapp.utils.Common.getDate
                ...
                override fun onBindData(
                    ...
                    if(orderHistoryList.get(position).getOrder_type().equals("1")){
                        ...
                        if(orderHistoryList.get(position).getStatus().equals("1")){
                            ...
                            tvOrderStatus2.setTextColor(resources.getColor(R.color.gray))
                            tvOrderStatus3.setTextColor(resources.getColor(R.color.gray))
                            tvOrderStatus4.setTextColor(resources.getColor(R.color.gray))

                            ivStatus1.setImageDrawable(ContextCompat.getDrawable(activity!!,R.drawable.ic_round_uncheck))
                            ivStatus2.setImageDrawable(resources.getDrawable(R.drawable.ic_round_check))
                            ivStatus3.setImageDrawable(resources.getDrawable(R.drawable.ic_round_check))
                            ivStatus4.setImageDrawable(resources.getDrawable(R.drawable.ic_round_check))

                            ivStatus1.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                            ivStatus2.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.gray))
                            ivStatus3.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.gray))
                            ivStatus4.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.gray))

                            view1.setBackgroundColor(resources.getColor(R.color.gray))
                            view2.setBackgroundColor(resources.getColor(R.color.gray))
                            view3.setBackgroundColor(resources.getColor(R.color.gray))

                        }else if(orderHistoryList.get(position).getStatus().equals("2")) {
                            tvOrderStatus.text=resources.getString(R.string.order_ready)

                            tvOrderStatus1.setTextColor(resources.getColor(R.color.colorPrimary))
                            tvOrderStatus2.setTextColor(resources.getColor(R.color.colorPrimary))
                            tvOrderStatus3.setTextColor(resources.getColor(R.color.gray))
                            tvOrderStatus4.setTextColor(resources.getColor(R.color.gray))

                            ivStatus1.setImageDrawable(resources.getDrawable(R.drawable.ic_round_uncheck))
                            ivStatus2.setImageDrawable(resources.getDrawable(R.drawable.ic_round_uncheck))
                            ivStatus3.setImageDrawable(resources.getDrawable(R.drawable.ic_round_check))
                            ivStatus4.setImageDrawable(resources.getDrawable(R.drawable.ic_round_check))

                            ivStatus1.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                            ivStatus2.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                            ivStatus3.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.gray))
                            ivStatus4.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.gray))
                            ...
                            tvOrderStatus1.setTextColor(resources.getColor(R.color.colorPrimary))
                            tvOrderStatus2.setTextColor(resources.getColor(R.color.colorPrimary))
                            tvOrderStatus3.setTextColor(resources.getColor(R.color.colorPrimary))
                            tvOrderStatus4.setTextColor(resources.getColor(R.color.gray))

                            ivStatus1.setImageDrawable(resources.getDrawable(R.drawable.ic_round_uncheck))
                            ivStatus2.setImageDrawable(resources.getDrawable(R.drawable.ic_round_uncheck))
                            ivStatus3.setImageDrawable(resources.getDrawable(R.drawable.ic_round_uncheck))
                            ivStatus4.setImageDrawable(resources.getDrawable(R.drawable.ic_round_check))

                            ivStatus1.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                            ivStatus2.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                            ivStatus3.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                            ivStatus4.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.gray))
                            ...
                            tvOrderStatus2.setTextColor(resources.getColor(R.color.colorPrimary))
                            tvOrderStatus3.setTextColor(resources.getColor(R.color.colorPrimary))
                            tvOrderStatus4.setTextColor(resources.getColor(R.color.colorPrimary))

                            ivStatus1.setImageDrawable(resources.getDrawable(R.drawable.ic_round_uncheck))
                            ivStatus2.setImageDrawable(resources.getDrawable(R.drawable.ic_round_uncheck))
                            ivStatus3.setImageDrawable(resources.getDrawable(R.drawable.ic_round_uncheck))
                            ivStatus4.setImageDrawable(resources.getDrawable(R.drawable.ic_round_uncheck))

                            ivStatus1.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                            ivStatus2.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                            ivStatus3.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
                            ivStatus4.imageTintList= ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
